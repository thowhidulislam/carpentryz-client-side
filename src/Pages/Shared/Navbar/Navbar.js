...
const Navbar = () => {
  ...
  const menuItems = (
    <>
      ...
      {user && (
        <li>
          <CustomLink to="/dashboard" className="hover:text-[#fab915]">
            Dashboard
          </CustomLink>
        </li>
      )}
      ...
      {user ? (
          ...
          <label tabIndex="0" className="active:bg-transparent">
            <div className="w-70 ">
              <li className="capitalize">
                <CustomLink to="">{user?.displayName}</CustomLink>
              </li>
              <p></p>
            </div>
          </label>
        ...
        <li title="login">
          <Link to="/login" className="active:bg-transparent  ">
            <FontAwesomeIcon
              icon={faRightToBracket}
              className="text-white btn btn-ghost btn-xs"
            />
          </Link>
        </li>
      )}
  ...
  return (
    <div className="navbar bg-[#202447] text-white lg:px-24">
      <div className="navbar-start">
        ...
        <a href="/" className="btn btn-ghost uppercase text-2xl">
          Carpentryz
        </a>
      </div>
