...
import photo from "../../assets/images/dev-image.png";
    ...
    <div>
      <div class="card max-w-screen-xl bg-base-100 shadow-xl mx-24 my-12">
        ...
        <div class="card-body items-center text-center">
          <h2 class="lg:text-6xl font-bold sm:text-xl">
            Md Thowhidul Islam Molla
          </h2>
          <p className="lg:text-2xl sm:text-lg">
            Email: thowhidulislam52@gmail.com
          </p>
          <div>
            <h1 className="text-xl my-7 font-bold">
