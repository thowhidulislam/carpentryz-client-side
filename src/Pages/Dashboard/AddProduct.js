...
const AddProduct = () => {
  ...
  const onSubmit = async (productData) => {
    ...
    axios
      .post(`https://api.imgbb.com/1/upload?key=${imageStorageKey}`, formData, {
        headers: {
    ...
    <div>
      ...
      <div className="card max-w-md bg-base-100 shadow-xl mx-auto my-7">
        ...
        >
          ...
          <input
            className="btn btn-md w-full max-w-xs bg-primary text-black border-0 hover:text-white hover:bg-secondary mt-7 text-xl"
            type="submit"
            value="ADD"
          />
        </form>
