      ...
      <div class="card w-96 bg-base-100 shadow-xl my-3">
        <div class="card-body">
          ...
          <div className="my-2">
            <Rating
              emptySymbol={
                <img src={starEmpty} className="icon" alt="star-empty" />
              }
              fullSymbol={
                <img src={starFull} className="icon" alt="star-full" />
              }
              onChange={(e) => setRating(e)}
            />
          </div>
          <button
            class="btn btn-primary text-black hover:btn-secondary hover:text-white"
